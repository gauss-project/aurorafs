...
type Interface interface {
	AnnouncePaymentThreshold(ctx context.Context, peer boson.Address, paymentThreshold *big.Int) error
}

// PaymentThresholdObserver is used for being notified of payment threshold updates
type PaymentThresholdObserver interface {
	NotifyPaymentThreshold(peer boson.Address, paymentThreshold *big.Int) error
}
...
func (s *Service) AnnouncePaymentThreshold(ctx context.Context, peer boson.Address, paymentThreshold *big.Int) error {
