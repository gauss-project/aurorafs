...
func TestCORSHeaders(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			name:           "no origin",
			allowedOrigins: []string{"https://gateway.aufs.io"},
			wantCORS:       false,
		},
		{
			name:           "single explicit",
			origin:         "https://gateway.aufs.io",
			allowedOrigins: []string{"https://gateway.aufs.io"},
			wantCORS:       true,
		},
		{
		...
		},
		{
			...
			origin:         "https://staging.gateway.aufs.io",
			allowedOrigins: []string{"https://gateway.aufs.io", "https://staging.gateway.aufs.io"},
			wantCORS:       true,
		},
		{
