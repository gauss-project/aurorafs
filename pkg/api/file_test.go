...
func TestFiles(t *testing.T) {
	...
	t.Run("encrypt-decrypt", func(t *testing.T) {
		...
		jsonhttptest.Request(t, client, http.MethodPost, fileUploadResource+"?name="+fileName, http.StatusOK,
			jsonhttptest.WithRequestBody(bytes.NewReader(simpleData)),
			jsonhttptest.WithRequestHeader(api.BosonEncryptHeader, "True"),
			...
			reader: tarFiles(t, []f{
				{
					...
					name:      "lorem.txt",
					dir:       "ipsum",
					reference: boson.MustParseHexAddress("4985af9dc3339ad3111c71651b92df7f21587391c01d3aa34a26879b9a1beb78"),
					header: http.Header{
