...
type Service struct {
	...
	settlementSentFunc func(boson.Address) (*big.Int, error)
	settlementRecvFunc func(boson.Address) (*big.Int, error)

	settlementsSentFunc func() (map[string]*big.Int, error)
	settlementsRecvFunc func() (map[string]*big.Int, error)

	receiveChequeFunc    func(context.Context, boson.Address, *chequebook.SignedCheque) error
	payFunc              func(context.Context, boson.Address, *big.Int) error
	setNotifyPaymentFunc settlement.NotifyPaymentFunc
	handshakeFunc        func(boson.Address, common.Address) error
	lastSentChequeFunc   func(boson.Address) (*chequebook.SignedCheque, error)
	lastSentChequesFunc  func() (map[string]*chequebook.SignedCheque, error)

	lastReceivedChequeFunc  func(boson.Address) (*chequebook.SignedCheque, error)
	lastReceivedChequesFunc func() (map[string]*chequebook.SignedCheque, error)

	cashChequeFunc    func(ctx context.Context, peer boson.Address) (common.Hash, error)
	cashoutStatusFunc func(ctx context.Context, peer boson.Address) (*chequebook.CashoutStatus, error)
}

// WithsettlementFunc sets the mock settlement function
func WithSettlementSentFunc(f func(boson.Address) (*big.Int, error)) Option {
	return optionFunc(func(s *Service) {
		s.settlementSentFunc = f
	})
}

func WithSettlementRecvFunc(f func(boson.Address) (*big.Int, error)) Option {
	return optionFunc(func(s *Service) {
...
func WithReceiveChequeFunc(f func(context.Context, boson.Address, *chequebook.SignedCheque) error) Option {
	return optionFunc(func(s *Service) {
		s.receiveChequeFunc = f
	})
}

func WithPayFunc(f func(context.Context, boson.Address, *big.Int) error) Option {
	return optionFunc(func(s *Service) {
		s.payFunc = f
	})
}
...
func WithHandshakeFunc(f func(boson.Address, common.Address) error) Option {
	return optionFunc(func(s *Service) {
		s.handshakeFunc = f
	})
}

func WithLastSentChequeFunc(f func(boson.Address) (*chequebook.SignedCheque, error)) Option {
	return optionFunc(func(s *Service) {
...
func WithLastReceivedChequeFunc(f func(boson.Address) (*chequebook.SignedCheque, error)) Option {
	return optionFunc(func(s *Service) {
...
func WithCashChequeFunc(f func(ctx context.Context, peer boson.Address) (common.Hash, error)) Option {
	return optionFunc(func(s *Service) {
		s.cashChequeFunc = f
	})
}

func WithCashoutStatusFunc(f func(ctx context.Context, peer boson.Address) (*chequebook.CashoutStatus, error)) Option {
	return optionFunc(func(s *Service) {
...
func (s *Service) ReceiveCheque(ctx context.Context, peer boson.Address, cheque *chequebook.SignedCheque) (err error) {
...
func (s *Service) Handshake(peer boson.Address, beneficiary common.Address) error {
...
func (s *Service) LastSentCheque(address boson.Address) (*chequebook.SignedCheque, error) {
...
func (s *Service) LastReceivedCheque(address boson.Address) (*chequebook.SignedCheque, error) {
...
func (s *Service) CashoutStatus(ctx context.Context, peer boson.Address) (*chequebook.CashoutStatus, error) {
