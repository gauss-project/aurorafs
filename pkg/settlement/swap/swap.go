...
type ApiInterface interface {
	...
	LastSentCheque(peer boson.Address) (*chequebook.SignedCheque, error)
	...
	LastReceivedCheque(peer boson.Address) (*chequebook.SignedCheque, error)
	...
	CashoutStatus(ctx context.Context, peer boson.Address) (*chequebook.CashoutStatus, error)
}
...
// LastSentCheque returns the last sent cheque for the peer
func (s *Service) LastSentCheque(peer boson.Address) (*chequebook.SignedCheque, error) {
...
// LastReceivedCheque returns the last received cheque for the peer
func (s *Service) LastReceivedCheque(peer boson.Address) (*chequebook.SignedCheque, error) {
