...
func (s *Service) PseudoPay(ctx context.Context, peer swarm.Address, amount *big.Int, checkAllowance *big.Int) (*big.Int, int64, error) {

	return big.NewInt(0),0,errors.New("not implemented")
}
