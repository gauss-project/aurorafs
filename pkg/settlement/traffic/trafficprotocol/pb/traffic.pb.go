...
type SignedCheque struct {
	Cheque    []*Cheque `protobuf:"bytes,1,rep,name=cheque,proto3" json:"cheque,omitempty"`
...
var fileDescriptor_50e185a42cb2d3c6 = []byte{
	...
	0xd8, 0x92, 0xc1, 0x2c, 0x09, 0x46, 0x05, 0x66, 0x0d, 0x6e, 0x23, 0x7e, 0x3d, 0x98, 0x46, 0x88,
	...
	0x35, 0x39, 0xb3, 0x20, 0x33, 0x35, 0xaf, 0x44, 0x82, 0x11, 0xa2, 0x0e, 0x2e, 0x20, 0xa4, 0xc0,
	0xc5, 0xed, 0x94, 0x9a, 0x97, 0x9a, 0x96, 0x99, 0x9c, 0x99, 0x58, 0x54, 0x09, 0x35, 0x07, 0x59,
	0x48, 0x48, 0x8b, 0x4b, 0xc0, 0xb9, 0x34, 0xb7, 0x34, 0x27, 0xb1, 0x24, 0xb3, 0x2c, 0x35, 0x20,
	0xb1, 0x32, 0xbf, 0xb4, 0x44, 0x82, 0x59, 0x81, 0x51, 0x83, 0x25, 0x08, 0x43, 0xdc, 0x49, 0xe6,
	0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e,
	0xe1, 0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18, 0xa2, 0x98, 0x0a, 0x92, 0x92, 0xd8, 0xc0,
	0x5e, 0x37, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xe4, 0x64, 0x66, 0xa5, 0x0b, 0x01, 0x00, 0x00,
}
...
func (m *SignedCheque) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Cheque) > 0 {
		for iNdEx := len(m.Cheque) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Cheque[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *SignedCheque) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Cheque = append(m.Cheque, &Cheque{})
			if err := m.Cheque[len(m.Cheque)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
